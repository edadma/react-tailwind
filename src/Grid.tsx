...
const colsClass: any = {
  ...
  7: 'grid-cols-1 md:grid-cols-3 xl:grid-cols-7',
  8: 'grid-cols-1 md:grid-cols-2 xl:grid-cols-8',
  9: 'grid-cols-1 md:grid-cols-3 xl:grid-cols-9',
  10: 'grid-cols-1 md:grid-cols-3 xl:grid-cols-10',
  11: 'grid-cols-1 md:grid-cols-3 xl:grid-cols-11',
  12: 'grid-cols-1 md:grid-cols-3 xl:grid-cols-12',
}
